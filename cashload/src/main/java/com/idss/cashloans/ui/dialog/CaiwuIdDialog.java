 ...
 *   显示财务id
 */
public class CaiwuIdDialog extends DialogFragment {
    private  Context context;
    private  String caiwuId;

    public CaiwuIdDialog(@NonNull Context context, String caiwuId) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_caiwuid, container, false);

        TextView  textView= view.findViewById(R.id.tv_caiwuid);
        textView.setText(caiwuId);
