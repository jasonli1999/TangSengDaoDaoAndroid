...
import com.idss.cashloans.ui.activity.main.BaseActivity;
...
public class ServiceWebViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView_toLeftArrow = (ImageView) findViewById(R.id.iv_back);
        imageView_toLeftArrow.setOnClickListener(v -> finish());

//        try {
//            // 获取AssetManager对象
//            AssetManager assetManager = getAssets();
//            // 打开指定名称的.txt文件（此处为example.txt）
//            InputStream inputStream = assetManager.open("yonghuzhucexieyi.txt");
//            // 将输入流转换成字符串形式
...
//
//            // 将字符串数据加载到WebView中
//            mWebView.loadDataWithBaseURL(null, stringBuilder.toString(), "text/plain", "UTF-8", null);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
