...
public class Step5WebViewActivity extends BaseActivity {
    private String mUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String murl = Constants.BASE_URL + "/apid/auth/yys/api/auth/authH5?memberId=" + SharePreferencesUtil.getString(Step5WebViewActivity.this, "MEMBERID", "");
        initWebSetting(murl);
    }
